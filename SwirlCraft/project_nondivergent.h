...
namespace SwirlCraft
{
    ...
    void projectNonDivergent(T* (&vel)[Dims], T* p, T* p_old, T* div, const T* collision, const T* (&collision_vel)[Dims], const Grid<T, Dims>& grid)
    {
        ...
        jacobiSolve(p, p_old, div, collision, grid, 80);
