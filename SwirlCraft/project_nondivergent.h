...
namespace SwirlCraft
{
    ...
    void projectNonDivergent(T* (&vel)[Dims], T* p, T* p_old, T* div, const T* collision, const T* (&collision_vel)[Dims], const Grid<T, Dims>& grid, const int32_t maxIterations=40)
    {
